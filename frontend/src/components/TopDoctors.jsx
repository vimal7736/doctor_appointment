                ...
                <div className='flex flex-col items-center justify-center text-center p-4'>
                        ...
                        <div className=' relative w-full grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6'>
                                {doctors && doctors.slice(0, 8).map((doctor) => (
                                        <div onClick={() => navigate(`/appointment/${doctor._id}`)} key={doctor._id} className='cursor-pointer text-slate-700 shadow-lg  duration-300 p-4 flex flex-col items-center bg-white rounded-md hover:shadow-lg hover:shadow-slate-700 transition-all  md:scale-90 md:hover:scale-110 '>
                        ...
                        <button
                                ...
                                className='bg-white mt-2 text-sm font-medium w-1/6 h-10 text-slate-800 shadow-xl rounded-full hover:text-white hover:bg-primary'>More</button>
                        <br />
                        <br />
                </div>
        )
