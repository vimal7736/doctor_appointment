...
const Doctor = () => {
  ...
  return (
    <div className='p-2 flex flex-col gap-4 '>
      <p className=' px-6 text-pretty font-poppins font-semibold'>Connect with experienced doctors for your healthcare needs</p>
      <div className='flex flex-col items-center md:flex-col justify-between '>
        <div className="flex flex-wrap justify-between py-4 px-6 gap-4">
          <p
            className="cursor-pointer border-2 border-gray-300 px-4 py-2 text-xs md:text-sm font-medium rounded-full hover:bg-danger/10 transition-all duration-300"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
          {filteredDoctors.map((doctor) => (
            <div
              className="border border-gray-200 shadow-sm rounded-lg p-4 bg-white hover:shadow-md transition-shadow duration-300 flex flex-col items-center text-center"
              key={doctor._id}
            >
